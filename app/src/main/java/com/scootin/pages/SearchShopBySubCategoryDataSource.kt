...
class SearchShopBySubCategoryDataSource (
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, SearchShopsByCategoryResponse> {
        return try {
            ...
            val response: Response<List<SearchShopsByCategoryResponse>> = apiService.findShopsBySubCategory(serviceAreaId, categoryId, requestSearch, nextPageNumber, params.loadSize)
