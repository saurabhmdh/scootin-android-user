...
class SearchProductBySubcategory (
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ProductSearchVO> {
        return try {
            ...
            val response: Response<List<SearchProductsByCategoryResponse>> = apiService.searchProductBySubCategories(serviceAreaId, nextPageNumber, params.loadSize, requestSearch)
