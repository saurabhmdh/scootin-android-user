...
class DealFooterAdapter(val appExecutors: AppExecutors) :DataBoundListAdapter<DealResponse, AdapterDealFooterBinding>(appExecutors,
    ...
    override fun createBinding(parent: ViewGroup): AdapterDealFooterBinding = AdapterDealFooterBinding.inflate(
        LayoutInflater.from(parent.context), parent, false
    )

    override fun bind(
        binding: AdapterDealFooterBinding,
        item: DealResponse,
        position: Int,
        isLast: Boolean
    ) {
