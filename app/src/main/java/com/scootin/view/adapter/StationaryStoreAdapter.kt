...
import com.scootin.databinding.AdapterItemAddStationaryStoreBinding
import com.scootin.network.AppExecutors
import com.scootin.network.response.sweets.SweetsStore
import timber.log.Timber

class StationaryStoreAdapter (
    val appExecutors: AppExecutors,
    val imageAdapterClickLister:StoreImageAdapterClickListener
): DataBoundListAdapter<SweetsStore, AdapterItemAddStationaryStoreBinding>(
    appExecutors,
    ...
    override fun createBinding(parent: ViewGroup):AdapterItemAddStationaryStoreBinding=
        AdapterItemAddStationaryStoreBinding.inflate(
            LayoutInflater.from(parent.context),parent,false
        )


    override fun bind(
        binding: AdapterItemAddStationaryStoreBinding,
        item: SweetsStore,
        position: Int,
        isLast: Boolean
    ) {
